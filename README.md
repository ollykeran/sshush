...
- **SSH server**: Optional TCP SSH server (`sshush server`) serving an interactive shell and remote commands to authorized keys. See [Config Reference](docs/config.md) `[server]` section.
